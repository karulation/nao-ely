...
function getMessageConfig() {
	const welcome = 'Yaho @user!\nWelcome to @subject\n\n@desc\n\nFeel free to join:\nhttps://chat.whatsapp.com/Cwbi2kLhsMK6gl6WxlLkkE'
	const bye = 'Sayonara @user! A member has left the group ~'
	const spromote = '@user is now a admin!'
	const sdemote = '@user is now not an admin!'
	const sDesc = 'Description has been changed to \n@desc'
	const sSubject = 'Group name changed to \n@subject'
	const sIcon = 'Group icon has been changed!'
	const sRevoke = 'Link group hase been changed! \n@revoke'
